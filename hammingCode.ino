...
const int change_bit_1 = 5; //Pin to change bit 1 of the original message with parity bits
const int change_bit_2 = 6; //Pin to change bit 2 of the original message with parity bits
const int change_bit_3 = 7; //Pin to change bit 3 of the original message with parity bits
const int change_bit_4 = 8; //Pin to change bit 4 ""
const int change_bit_5 = 9; //Pin to change bit 5 ""
const int change_bit_6 = 10; //Pin to change bit 6 ""
const int change_bit_7 = 11; //Pin to change bit 7 ""

const int final_bit_1 = A1; //Bit 1 from final message
const int final_bit_2 = A2; //Bit 2 from final message
const int final_bit_3 = A3; //Bit 3 ""
const int final_bit_4 = A4; //Bit 4 ""
...
void setup() {
  ...
  pinMode(change_bit_1, OUTPUT);
  pinMode(change_bit_2, OUTPUT);
  pinMode(change_bit_3, OUTPUT);
  pinMode(change_bit_4, OUTPUT);
  pinMode(change_bit_5, OUTPUT);
  pinMode(change_bit_6, OUTPUT);
  pinMode(change_bit_7, OUTPUT);

  pinMode(final_bit_1, INPUT);
  pinMode(final_bit_2, INPUT);
  pinMode(final_bit_3, INPUT);
  pinMode(final_bit_4, INPUT);
